...
export default function Footer() {
  ...
  /**
   * ✅ Social (NO duplicates)
   * - Uses your premium pill buttons only (no second mini-icon row)
   * - Replace the placeholder hrefs with your real links
   */
  const social = useMemo(
    () => [
      {
        label: "LinkedIn",
        href: "https://www.linkedin.com/in/collins-ayidan/",
  ...
  const openCalendly = useCallback(async () => {
    ...
    // OPTIONAL: require functional OR marketing consent before opening Calendly
    const allowed = consent?.functional === true || consent?.marketing === true;
    ...
    if (!script) {
      ...
      script.onerror = () => window.open(calendlyUrl, "_blank", "noopener,noreferrer");
  ...
  return (
    <footer
      className={[
        "relative overflow-hidden text-white border-t border-white/10",
        // ✅ Matches your other dark sections (same base + subtle gradient)
        "bg-collin-navy-gradient",
      ].join(" ")}
      aria-labelledby="footer-heading"
    >
      {/* ✅ Same grid overlay style as your other sections */}
      <div
        aria-hidden="true"
      ...
      {/* ✅ Optional subtle noise (keep it light) */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-[url('/patterns/noise.png')] bg-repeat mix-blend-overlay opacity-[0.03]"
      />
        ...
        <div className="flex flex-col gap-12">
          ...
          <div className="grid gap-10 lg:grid-cols-12 lg:items-start">
            ...
            <div className="lg:col-span-5">
              ...
              {/* Social (single row — NO duplicates) */}
              <div className="mt-7">
            ...
            <div className="lg:col-span-7 grid gap-8 sm:grid-cols-2">
              <nav aria-label="Footer navigation">
                ...
                <ul className="mt-4 space-y-3 text-bodysm">
                  ...
                  <li>
                    <Link href="/services/digital-solutions" className="text-white/75 hover:text-white transition-colors">
                      UX Design
                    </Link>
                  </li>
                </ul>
              ...
              <nav aria-label="Company">
                ...
                <ul className="mt-4 space-y-3 text-bodysm">
                  ...
                  <li>
                    <a href="mailto:info@collinalitics.co.uk" className="text-white/75 hover:text-white transition-colors">
...
function CalendarIcon({ className }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth="1.8" stroke="currentColor" aria-hidden="true">
