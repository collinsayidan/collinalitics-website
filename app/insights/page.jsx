    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="container-wrapper relative z-10 py-16 sm:py-20">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          {/* Breadcrumb */}
          <nav aria-label="Breadcrumb" className="text-sm text-collin-slate flex flex-wrap items-center gap-2">
        ...
        <div className="mt-12 mx-auto max-w-4xl">
          <div className="grid gap-4 sm:grid-cols-[1fr_auto] sm:items-center">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white/95 px-5 py-4 shadow-sm">
              <p className="text-xs font-semibold tracking-widest text-gray-500 uppercase">Showing</p>
        ...
        {/* Bottom nav / CTA */}
        <div className="mt-16 sm:mt-20 mx-auto max-w-4xl rounded-3xl border border-gray-200 bg-white/95 p-7 sm:p-9 shadow-xl">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div className="max-w-2xl">
              <p className="text-xs font-semibold tracking-widest text-collin-slate uppercase">
                Want help applying this?
              </p>
              <h2 className="mt-2 text-h4 text-collin-navy">
                Turn insight into better reporting.
              </h2>
      ...
      {/* Local “component styles” using Tailwind utility classes */}
      <style jsx>{`
        .NavPill {
          display: inline-flex;
          align-items: center;
